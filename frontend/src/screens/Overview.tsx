                ...
                {versions.map(v => (
                  <div key={v.version} className="grid-row" style={{ gridTemplateColumns: ".6fr 1fr 1.6fr 1fr 1fr", padding: "12px 20px", borderTopColor: "var(--line)" }}>
                    ...
                    <span className="row" style={{ justifyContent: "flex-end", gap: 6 }}>
                      ...
                      {!v.active && v.status === "published" && can("reviewer") && <Button size="sm" variant="outline" style={{ height: 26 }} onClick={() => life.setActive(v.version)}>Set active</Button>}
                    </span>
                  </div>
                ))}
              </Card>
