...
export const DOMAINS: DomainSummary[] = [
  {
    name: "rgm", description: "Revenue growth management", base_iri: "http://polestar.ai/rgm/", quorum: 3, schema: "gold", catalog: "rgm", materialization: "view · Liquid Clustering", target: "finops_metadata.rgm_graph", mcpExposed: true, disabledTools: ["run_action", "materialize_cohort"], triples: "263,695", lastBuild: "2 h ago",
    versions: [
  ...
  {
    name: "hr", description: "People and departments", base_iri: "http://polestar.ai/hr/", quorum: 1, schema: "people", catalog: "hr", materialization: "table · OPTIMIZE nightly", target: "finops_metadata.hr_graph", mcpExposed: true, disabledTools: [], triples: "41,880", lastBuild: "3 d ago",
    versions: [
  ...
  { name: "finops", description: "Cloud cost allocation", base_iri: "http://polestar.ai/finops/", quorum: 2, schema: "billing", catalog: "finops_metadata", materialization: "view", target: "finops_metadata.finops_graph", mcpExposed: false, disabledTools: [], triples: "—", lastBuild: "never", versions: [], lease: null, review: null },
];
