...
export interface AiFacts { connection: string | null; kind: string; deployment: string | null; in_use?: boolean; running?: AiFacts | null }   // in_use false: the domain names it, the deployment runs `running`
export interface SourceFacts { kind: string; connection: string | null; connection_id: string | null; catalog: string | null; schema: string | null; schemas?: string[]; sources?: SourceFactsEntry[]; host: string | null; auth_mode: string; auth_header: string; materialization: string; target_schema: string | null; last_test: ConnResult | null; ai: AiFacts | null; connections_backend?: "local" | "hub" | "none"; missing_connection_id?: string | null }
